/*
    -- MAGMA (version 2.6.2) --
       ...
       @generated from sparse/blas/zparilu.cpp, normal z -> d, Wed Apr 20 17:38:06 2022
*/
...
#define cusparseDcsrsv_analysis(handle, trans, m, nnz, descr, val, row, col, info)              \
    {                                                                                           \
        ...
        hipsparseDcsrsv2_bufferSize(handle, trans, m, nnz, descr, (double*)val, row, col,                 \
                                   linfo, &bufsize);                                            \
        if (bufsize > 0)                                                                        \
           magma_malloc(&buf, bufsize);                                                         \
        hipsparseDcsrsv2_analysis(handle, trans, m, nnz, descr, (double*)val, row, col, linfo,            \
