/*
   ...
   @generated from src/zgetrf_panel_native.cpp, normal z -> s, Wed Apr 20 17:36:40 2022
*/
    ...
    magma_queue_t queue, magma_queue_t update_queue)
{
    ...
    if (panel_nb <= recpnb) {
        ...
        // panel on A2
        magma_sgetrf_recpanel_native(m-n1, n2, dA(n1,n1), ldda, dipiv+n1, dipivinfo+n1, dinfo, gbstep+n1, queue, update_queue);
