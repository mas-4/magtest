/*
    -- MAGMA (version 2.6.2) --
       ...
       @generated from src/zgetrf_gpu.cpp, normal z -> s, Wed Apr 20 17:36:12 2022
    ...
    magma_int_t *info )
{
    ...
    magma_sgetrf_gpu_expert(m, n, dA, ldda, ipiv, info, nb, MagmaHybrid);
    return *info;
} /* magma_sgetrf_gpu */
    ...
    magma_int_t *info )
{
    ...
    magma_sgetrf_gpu_expert(m, n, dA, ldda, ipiv, info, nb, MagmaNative);
    return *info;
} /* magma_sgetrf_native */
