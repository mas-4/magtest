/*
    -- MAGMA (version 2.6.2) --
       ...
       @generated from src/zgetrf_gpu.cpp, normal z -> d, Wed Apr 20 17:36:12 2022
    ...
    magma_int_t *info )
{
    ...
    magma_dgetrf_gpu_expert(m, n, dA, ldda, ipiv, info, nb, MagmaHybrid);
    return *info;
} /* magma_dgetrf_gpu */
    ...
    magma_int_t *info )
{
    ...
    magma_dgetrf_gpu_expert(m, n, dA, ldda, ipiv, info, nb, MagmaNative);
    return *info;
} /* magma_dgetrf_native */
