/*
    -- MAGMA (version 2.6.2) --
       ...
       @generated from magmablas/zgetf2_kernels_var.cu, normal z -> s, Wed Apr 20 17:38:06 2022
*/
...
/******************************************************************************/
__global__
void sswap_kernel_vbatched_org(
        int max_n,
        ...
        magma_int_t step, magma_int_t** ipiv_array )
{
    ...
    sswap_device(my_N, dA, my_ldda, step, ipiv);
}
