/*
    -- MAGMA (version 2.6.2) --
       ...
       @generated from magmablas/zgetf2_kernels_var.cu, normal z -> d, Wed Apr 20 17:38:06 2022
*/
...
/******************************************************************************/
__global__
void dswap_kernel_vbatched_org(
        int max_n,
        ...
        magma_int_t step, magma_int_t** ipiv_array )
{
    ...
    dswap_device(my_N, dA, my_ldda, step, ipiv);
}
